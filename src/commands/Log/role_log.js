        ...
        if(interaction.member.permissions.has(PermissionsBitField.Flags.Administrator)) {
            ...
            switch(SubCmd){
                case "set": {
                    ...
                    await guilds_Schema.updateOne({ guild_id: interaction.guild.id }, { rolelog_id: channel.id }, { upsert: true })
                ...
                case "reset": {
                    ...
                    await guilds_Schema.updateOne({ guild_id: interaction.guild.id }, { rolelog_id: null }, { upsert: true })
                    interaction.reply({ content: t("rolelog.res_succes", {lng: interaction.locale}) })
                    break
